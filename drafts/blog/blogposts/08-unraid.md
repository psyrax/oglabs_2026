# Unraid: el sistema operativo para tu homelab de LLMs

> **Serie:** Sistemas Multi-Agente en tu Homelab — Post 8 de 8
...
Unraid detecta automáticamente las GPUs NVIDIA disponibles y las expone a los contenedores
que lo soliciten.
