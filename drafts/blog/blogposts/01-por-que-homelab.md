# Por qué un homelab para experimentar con LLMs y agentes

> **Serie:** Sistemas Multi-Agente en tu Homelab — Post 1 de 6
...
| LLM server | PC de escritorio (x86, 8GB VRAM) | Ollama con múltiples modelos |
